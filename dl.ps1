...
$files = @("03_6_encrypt_drive.ps1", "04_3_auto_lock_05_2_passwords.ps1", "09_2_dns_filtering.ps1", "10_3_disable_autorun.ps1", "browser_policy.ps1", "logon_banner.ps1", "settings.ps1", "system_restore_point.ps1")
